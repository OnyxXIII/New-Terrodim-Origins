team leave @s
execute as @s[type=!#ntorigins:naga_pacify_mobs_exceptions] at @s if entity @e[type=minecraft:player,limit=1] run data modify entity @s AngerTime set value 40000
